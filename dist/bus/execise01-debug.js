define("bus/execise01-debug", ["js/jQuery-debug"], function(require, t, o) {
    function n() {
        g == i.length - 1 ? g = 0 : g++, $(".body-cursol").animate({
            left: -g * c + "px"
        }, .5)
    }
    var $ = require("js/jQuery-debug"),
        c = ($(".nav-cursol>li"), $(".body-cursol img").get(0).clientWidth),
        i = $(".body-cursol img").get();
    $(".body-cursol").css({
        width: c * $(".body-cursol img").get().length + "px"
    }), $(".sf-cursol").css({
    ...
    $(".prev").on("click", function(e) {
        0 == s ? s = i.length - 1 : s < i.length && s--, $(".body-cursol").animate({
            left: -s * c + "px"
        }, .5)
    }), $(".next").on("click", function(e) {
        s == i.length - 1 ? s = 0 : s >= 0 && s++, $(".body-cursol").animate({
            left: -s * c + "px"
        }, .5)
    });
    var u = null,
