define("bus/needTip-debug", ["module-tools/needTip-debug", "js/jquery-1.11-debug.2"], function(require, exports, module) {
    require("module-tools/needTip-debug"), $(".need-tip-father").needTip({
        location: "right",
        content: "dssadasdsad"
    })
});
define("module-tools/needTip-debug", ["js/jquery-1.11-debug.2"], function(require, exports, module) {
    require("js/jquery-1.11-debug.2"),
        function($, window, document, undefined) {
            ...
            NeedTip.prototype = {
                ...
                init: function() {
                    var me = this;
                    me.getContent(), me.render(), me.tipSon.hide(), me.getLocation(), me.events()
                },
                render: function() {
                    var me = this,
                        con = me.getContent();
...
! function(global, factory) {
    ...
    jQuery.offset = {
        ...
        return this.length
    }, jQuery.fn.andSelf = jQuery.fn.addBack, "function" == typeof define && define.amd && define("js/jquery-1.11-debug.2", [], function() {
        return jQuery
    });
