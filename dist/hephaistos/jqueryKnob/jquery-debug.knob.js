! function(factory) {
    "object" == typeof exports ? module.exports = factory(require("jquery-debug")) : "function" == typeof define && define.amd ? define("hephaistos/jqueryKnob/jquery-debug.knob", ["jquery-debug"], factory) : factory(jQuery)
}(function($) {
    "use strict";
    var k = {},
        max = Math.max,
